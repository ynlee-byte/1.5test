...
const Feature = () => {
  return (
    <section className="feature pt-120 ml-12 mr-12">
            ...
            <div className="feature-wrapper mt-60">
              <div className="feature-slider-wrapper">
                <Swiper
                  ...
                  className="feature-slider-two swiper"
                >
                      ...
                      <div className="content">
                        <div className="content-inner">
                          ...
                          <h3 className="fw-7 mt-16">
                            <Link href="/games/2">Vortex</Link>
                          </h3>
                        </div>
                        <div className="cta mt-50 text-end">
                          <Link href="/games/2" aria-label="more informations" title="more informations" className="fw-7">
                    ...
                    <div className="feature-slider__single">
                      ...
                      <div className="content">
                        <div className="content-inner">
                          ...
                          <h3 className="fw-7 mt-16">
                            <Link href="/games/2">Fortnite</Link>
                          </h3>
                        </div>
                        <div className="cta mt-50 text-end">
                          <Link href="/games/2" aria-label="more informations" title="more informations" className="fw-7">
