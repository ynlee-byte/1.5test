...
import Collectibles from "@/public/images/games/trending/five.png";
import CryptoCutie from "@/public/images/games/trending/four.png";
import BitBlossom from "@/public/images/games/trending/one.png";
import DigitalDolly from "@/public/images/games/trending/six.png";
import TechnoTots2 from "@/public/images/games/trending/three.png";
...
const Experience = () => {
  return (
    <div className="pt-120 build-experience market-slider">
          ...
          <div className="col-12">
            <div className="package__tab-intro">
              <div className="row align-items-center vertical-column-gap">
                <div className="col-12 col-md-6">
                  <h5 className="fw-6">Build Your Experience</h5>
                </div>
                <div className="col-12 col-md-6">
            ...
            <div className="package-slider-wrapper mt-40">
              <Swiper
                ...
                className="package-slider-experience swiper"
              >
                            ...
                            <div className="author-meta">
                              <Link href="/public-profile" aria-label="view profile" title="view profile">
                                <span className="hexagon-wrapper">
                                  <Image src={item.creator.avatar} alt="View Profile" width={50} height={50} />
            ...
            <div className="slider-footer mt-40">
              <div className="slider-navigation">
                <button type="button" aria-label="prev slide" title="prev slide" className="prev-experience slider-btn">
                  <i className="ti ti-chevron-left"></i>
                </button>
                <button type="button" aria-label="next slide" title="next slide" className="next-experience slider-btn">
                  <i className="ti ti-chevron-right"></i>
                </button>
              </div>
              <div className="experience-slider-progress pagination-two"></div>
            </div>
          </div>
        </div>
      </div>
